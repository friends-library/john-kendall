...
The principle or seed of Life we profess is still the same,
...
It was turning inward that turned me from deism to Christianity;
...
yet I hope by this means not only as you very sensibly write,
