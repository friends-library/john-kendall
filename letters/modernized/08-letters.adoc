...
and some faculty for speaking and writing on religious subjects; when in the meantime,
...
and for our preparation to have admission somewhere, anywhere,
...
which enables us to run through the dangers and difficulties
